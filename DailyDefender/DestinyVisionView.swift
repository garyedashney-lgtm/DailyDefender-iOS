...
struct DestinyVisionView: View {
    ...
    // Reuse page shield for brand consistency
    private let shieldAsset = "identityncrisis"

    // --- Per-keystroke persistence (device-local, fast) ---
    @AppStorage("dvs_physiology_text")  private var physiologyText: String  = ""
    @AppStorage("dvs_piety_text")       private var pietyText: String       = ""
    @AppStorage("dvs_people_text")      private var peopleText: String      = ""
    @AppStorage("dvs_production_text")  private var productionText: String  = ""
    ...
    var body: some View {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Write out a full destiny vision:")
                            .font(.system(size: 18, weight: .bold))
                            .foregroundStyle(AppTheme.textPrimary)

                        Text("""
                        In each quadrant, define your vision with “I” and “My” statements — and read them every day.
                        """)
                    ...
                    // ===== Physiology =====
                    DestinyVisionSectionHeader(label: "Physiology", emoji: "🏋")
                    ...
                    DestinyVisionPillarEditor(
                        text: Binding(
                            get: { physiologyText },
                            set: { physiologyText = $0 } // persists every keystroke
                        ),
                        placeholder: "“I am…”   “I will…”"
                    )

                    // ===== Piety =====
                    DestinyVisionSectionHeader(label: "Piety", emoji: "🙏")
                    ...
                    // ===== People =====
                    DestinyVisionSectionHeader(label: "People", emoji: "👥")
                    ...
                    // ===== Production =====
                    DestinyVisionSectionHeader(label: "Production", emoji: "💼")
                    ...
                    HStack {
                        ...
                        .accessibilityLabel("Save Destiny Vision snapshot to Journal Library")
                    }
                    .padding(.top, 10)
        ...
        // Footer Goals button → pop back to Goals root (support both signals)
    ...
    private func saveToJournal() {
        ...
        let body = [
            "🚀 Destiny Vision — Snapshot (\(dateStr))",
            "",
        ...
        JournalMemoryStore.shared.addFreeFlow(
            title: "DVS: Destiny Vision Snapshot",
            body: body,
            createdAt: date
        )
...
// MARK: - Section Header
private struct DestinyVisionSectionHeader: View {
    let label: String
    let emoji: String
    var body: some View {
        HStack(spacing: 8) {
...
private struct DestinyVisionPillarEditor: View {
